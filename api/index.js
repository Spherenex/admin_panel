...
//   const key_id = process.env.RAZORPAY_KEY_ID || 'rzp_test_psQiRu5RCF99Dp';
//   const key_secret = process.env.RAZORPAY_KEY_SECRET || 'MLb1hejwBSaeg9ysJjO24O0u';
  
//   console.log('Initializing Razorpay with key:', key_id.substring(0, 10) + '...');
