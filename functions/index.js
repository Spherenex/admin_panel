...
// const USE_MOCK_RESPONSES = true; // Set this to false for real API calls

// // Enhanced CORS configuration to allow frontend access
// app.use(cors({
//   origin: ['http://localhost:5174', 'http://127.0.0.1:5174', 'http://localhost:3001'], // Added your frontend URL
...
//           // 'https://testpay.easebuzz.in/payout/initiate',
//           'https://testpay.easebuzz.in/api/v1/payout/initiate', // Try this alternate endpoint
//           payoutData, 
//           {
//             headers: {
...
//           // Try different API endpoints if needed
//           // 'https://testpay.easebuzz.in/payout/status',
//           'https://testpay.easebuzz.in/api/v1/payout/status',
//           statusData,
//           {
//             headers: {
//               'Content-Type': 'application/json',
