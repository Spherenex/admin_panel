...
//           {/* Modified condition to include both payment-completed and pending_vendor_confirmation statuses */}
//           {(order.status === 'pending_vendor_confirmation' || order.status === 'payment-completed') && (
//             <>
